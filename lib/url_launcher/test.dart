...
class MyAppUrlLauncher extends StatelessWidget {
  const MyAppUrlLauncher({Key? key}) : super(key: key);
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    canLaunchUrl(Uri(scheme: 'sms', path: '123',
  ...
  Future<void> _makeSmsSend(String smsText) async {
    final Uri launchUri = Uri(
      scheme: 'sms',
      path: smsText,
    );
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: _hasSmsSupport
                        ? () => setState(() {
                      _launched = _makeSmsSend(_phone);
                    })
                        : null,
                    child: _hasSmsSupport
                        ? const Text('Make sms send')
